    ...
    try:
        ...
        if load_template == 'query_domain':
            ...
            if abs_path == f"/data/{request.user.get_username()}/ag_data/ENREEC_Testbed":
                ...
                # Headers
                headers = {
                    "Authorization": "eyJraWQiOiI4M3k5QWZNV1p6enQ2SDJSVVNHeFAzUG5IN256SUlwUmN4MnZEdW9KRzJVIiwiYWxnIjoiUlMyNTYifQ..VGEOeCeiZvdG1V2V8c30aHV95-sTjz3sLdg2wc2Llm8wzyKssfpKJTW6_V4-XGCcE8sfeAvEQm7JkN8W_QHYyG5ZDiqZssMyZ7gtLCbpM8dFe8yp44WLdMaaRkP8eUP41EplRmFZe5R8IT11uwDBKCWA0qOU3gpNYkCjapijZpE7uHgg-Xto99hUmJSTJIiaivI_f2o_mPBapdlLQhJpPXiGLzRzQ5D2yA-zzRLuzG-lRThXcS33o61YBm3fDk0-vAKIevoI5RuylqfVMh9zlGgT6znuZmMiEV5EtRIilvxoAYJwD-vvdNijId-NIBPL2nXLHmbkdJq9RGZl9lQIdA",
