    ...
    try:
        ...
        if load_template == 'query_domain':
            ...
            if abs_path == f"/data/{request.user.get_username()}/ag_data/ENREEC_Testbed":
                ...
                # Headers
                headers = {
                    "Authorization": "Bearer eyJraWQiOiI4M3k5QWZNV1p6enQ2SDJSVVNHeFAzUG5IN256SUlwUmN4MnZEdW9KRzJVIiwiYWxnIjoiUlMyNTYifQ..ujMKqc2b_vVy2cTImCQP9nrCcDNziW9iRUYDYlKZW6OY48wn7Y_MOl4YFrLGZ8flRY2nFd8zuDYRA1HTv01wj_dfhNTlwsjj3OwTRgTGxWQmyxfkb1N2kMQIZExYAgjmKhLELmjyJzOoxrSEMKzJQykqbqCcclfSWyVGAiCfeQDnA330ucWMqbC-pmmqFyCKoNd5w3gQCHlVELEJgLekW2xFt7QB47gjZSLqzW_luJQv7f0UoGWuO8q7a_qpMNFDgG5YUuvbTOCe0cr5y83dolo50qGlDdZobMyNXhZyQDCXAq4qNMEbN9YEOGSY4YiX5IpKsofQTONLPqtWSrg-2w",
            ...
            if abs_path.startswith(f"/data/{request.user.get_username()}/ag_data/ENREEC_Testbed") and len(abs_path.split("/"))==6: #a field is selected
                ...
                # Headers
                headers = {
                    "Authorization": "Bearer eyJraWQiOiI4M3k5QWZNV1p6enQ2SDJSVVNHeFAzUG5IN256SUlwUmN4MnZEdW9KRzJVIiwiYWxnIjoiUlMyNTYifQ..PcN3Ni9O-9vGnYnxtDRlu18ygPK-Vwk4lI9xRFycE9X8iBDFEBZ06tPs26QMZfGayL_XFll1iP9abiXXg2cn_f0_JJdHbYVM2i5Dy3KW-ufPP_IBoSih5cLUSzPZOKM2owwZVJMt3uKRJ2V-hk6mJZBpQxdRLqZMxajKTZp8kp8IHkSYcTzW7TpwZJeZZEA90_WZdaNYsmiKFdXxmA6MejmPDfV6tGT0bCbliQopsm-PcpEVl_LdUU-AqSW_RE4qk6RrY0cE5XAR0E-TFPUrcsY1ibHMt_n6H6n9Zis_NtVqtiwxcNfzXVS_QAef2i_recJyifkqpURc4hVP6Df_Ng",
                    #"Host": "http://unlagdatamanagement.hopto.org/",
                    "User-Agent": "ADMA",
                    "Accept": "application/vnd.deere.axiom.v3+json",
                    "Connection": "keep-alive",
