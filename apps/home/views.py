    ...
    try:
        ...
        if load_template == 'query_domain':
            ...
            if abs_path == f"/data/{request.user.get_username()}/ag_data/ENREEC_Testbed":
                ...
                # Headers
                headers = {
                    "Authorization": "Bearer eyJraWQiOiI1VkRFMldCSTc4RjNMdDczUnMxQnNVWUZ2dTFHWXV4YmI1T18wekViai1rIiwiYWxnIjoiUlMyNTYifQ..OwXuyubxDXfu63DjDIqoexGzo_eN_aqjFL9eSydssacjTXMSu6c91Yo11okZUbRZZMz9MQes3O0sSP50ez4njdmZNIhu6hgwDMMfN3U-qbvFD_z3zPsX7Ru3r8pJLHe68a6FI8A8UZP_tEAyO6ilJhAIMad7sQYErcdux0EhjOdAITR0LCE1LE9Z39M0px6e0mkoKdy938yTxMBLqt4E6YEPVVwq-4gZCb_rpTFOCJCK_6wlsS1zugmD34i8_8fizbuwlt-PWiM68mjUTKRgnPrl0GHi7AIiHFopLv0NNgmgBRgEuW4hPK6aGTNto1T-jehPRfALV9Rp6x0qm9G2Dw",
            ...
            if abs_path.startswith(f"/data/{request.user.get_username()}/ag_data/ENREEC_Testbed") and len(abs_path.split("/"))==6: #a field is selected
                ...
                # Headers
                headers = {
                    "Authorization": "Bearer eyJraWQiOiI4M3k5QWZNV1p6enQ2SDJSVVNHeFAzUG5IN256SUlwUmN4MnZEdW9KRzJVIiwiYWxnIjoiUlMyNTYifQ..VGEOeCeiZvdG1V2V8c30aHV95-sTjz3sLdg2wc2Llm8wzyKssfpKJTW6_V4-XGCcE8sfeAvEQm7JkN8W_QHYyG5ZDiqZssMyZ7gtLCbpM8dFe8yp44WLdMaaRkP8eUP41EplRmFZe5R8IT11uwDBKCWA0qOU3gpNYkCjapijZpE7uHgg-Xto99hUmJSTJIiaivI_f2o_mPBapdlLQhJpPXiGLzRzQ5D2yA-zzRLuzG-lRThXcS33o61YBm3fDk0-vAKIevoI5RuylqfVMh9zlGgT6znuZmMiEV5EtRIilvxoAYJwD-vvdNijId-NIBPL2nXLHmbkdJq9RGZl9lQIdA",
                    #"Host": "http://unlagdatamanagement.hopto.org/",
                    "User-Agent": "ADMA",
                    "Accept": "application/vnd.deere.axiom.v3+json",
                    "Connection": "keep-alive",
